...
public interface ApplicationMasterRepository
	...
	@Query(value = "SELECT new ApplicationMaster( "
			...
			+"ORDER BY EXTRACT(EPOCH FROM AGE(CURRENT_TIMESTAMP, applnWf1.createTs)) ASC", nativeQuery = false) //ascending order since epoch works opposite to timestamp in terms of ordering
